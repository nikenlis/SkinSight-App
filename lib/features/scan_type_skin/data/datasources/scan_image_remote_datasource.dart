...
import 'package:skinsight/features/scan_type_skin/data/models/scan_image_model.dart';

import '../../../../core/api/api_config.dart';
import '../../../../core/error/exceptions.dart';

abstract class ScanImageRemoteDatasource {
  Future<ScanImageModel> getScanImage({required File image});
}

class ScanImageRemoteDatasourceImpl implements ScanImageRemoteDatasource {
  final dio = Dio(
    BaseOptions(
  ...
  @override
  Future<ScanImageModel> getScanImage({required File image}) async {
    ...
    try {
      ...
      return ScanImageModel.fromJson(response.data['data']);

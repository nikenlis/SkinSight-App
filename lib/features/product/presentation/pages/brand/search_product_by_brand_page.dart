...
import 'package:skinsight/features/product/presentation/bloc/search/search_bloc.dart';

import '../../../../../core/ui/shared_method.dart';
import '../../../domain/entities/product_entity.dart';
import '../../widgets/loading/product_list_item_loading.dart';
import '../../widgets/product_list_item.dart';

class SearchProductByBrandPage extends StatefulWidget {
  final String data;
  const SearchProductByBrandPage({super.key, required this.data});

  @override
  State<SearchProductByBrandPage> createState() =>
      _SearchProductByBrandPageState();
}

class _SearchProductByBrandPageState extends State<SearchProductByBrandPage> {
          ...
          title: CupertinoSearchTextField(
            ...
            onChanged: (value) {
              if (value.isNotEmpty) {
                ...
                Future.delayed(const Duration(milliseconds: 500), () {
                  context.read<SearchBloc>().add(GetProductBrandBySearch(
                      query: value, brand: widget.data));
                });
              } else {
                setState(() {
                  isSearching = false;
            ...
            onSubmitted: (String value) {
              context.read<SearchBloc>().add(
                  GetProductBrandBySearch(query: value, brand: widget.data));
            },
          ),
        ),
